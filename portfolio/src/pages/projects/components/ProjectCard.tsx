  ...
  return (
    <article className="project-card">
      ...
      <div className="project-card-body">
        <h3 className="heading-md project-card-title">{title}</h3>
        <p className="text-body project-card-description">{description}</p>
              ...
              <div className="project-expand-content">
                {hasFeatures && (
                  <div className="project-detail-section">
                    ...
                    <ul className="project-feature-list">
                      {features.map((f, i) => (
                        <li key={i} className="text-body project-feature-item">{f}</li>
                      ))}
                    </ul>
                  </div>
                )}
                {architecture && (
                  <div className="project-detail-section">
                    ...
                    <p className="text-body">{architecture}</p>
                  </div>
                )}
              </div>
            )}
